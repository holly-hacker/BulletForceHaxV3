...
export default function MessageListWithSidePanel({ messages }: { messages: UnpackedDevtoolsMessage[] }): React.JSX.Element {
	...
	return (
		<div style={{ width: '100%', height: '100%', display: 'flex' }}>
			<div ref={scrollRef} style={{ height: '100%', overflow: 'auto', width: isOpen ? '50%' : '100%' }}>
				<MessageList scrollRef={scrollRef} messages={messages} selectedMessage={selectedMessage} onItemSelected={setMessage} />
			</div>
			{isOpen && (
