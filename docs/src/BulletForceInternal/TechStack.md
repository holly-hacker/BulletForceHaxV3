...
For networking, Bullet Force uses Photon Unity Networking (PUN). This section of the book will not explain PUN in detail.

Bullet Force also uses various other libraries. These will be listed at a later point.
